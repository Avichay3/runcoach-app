...
━━ כשבונים תוכנית שבועית — השתמש בטבלה ━━

| יום | סוג | מרחק | קצב | מטרה |
|-----|-----|------|-----|-------|
| שני | קל | 8 ק"מ | ${paceZones?.easy || '?'} דק/ק"מ | שיקום, בסיס אווירובי |
| רביעי | טמפו | 10 ק"מ | ${paceZones?.threshold || '?'} דק/ק"מ | שיפור סף לקטי |
| שישי | ארוכה | 16 ק"מ | ${longRunPace || '?'} דק/ק"מ | סיבולת, שריפת שומן |
